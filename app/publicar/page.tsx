...
const formSchema = z.object({
  ...
  precio: z.string()
    .min(1, "Por favor ingresa un precio"),
  moneda: z.string({
  ...
  ciudad: z.string({
    required_error: "Por favor selecciona una ciudad",
  }),
  proveedor: z.string()
  ...
  contactoPor: z.enum(["email", "llamada-whatsapp", "todos"], {
    required_error: "Por favor selecciona cómo deseas ser contactado",
  }),
});
      ...
      <div className="bg-gray-900/50 backdrop-blur-sm border-b border-gray-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex gap-2">
            ...
            <h1 className="text-lg font-semibold flex items-center ml-2">Publicar Anuncio</h1>
          </div>
        </div>
      </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ej: Instalación profesional de aires acondicionados" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                    ...
                    >
                      ...
                      <SelectContent>
                        {selectedDepartamento &&
                          ciudades[selectedDepartamento as keyof typeof ciudades]?.map((ciudad) => (
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Tu nombre o nombre de la empresa" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
